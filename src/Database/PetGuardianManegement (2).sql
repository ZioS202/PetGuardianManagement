...
begin
    if (:new.SoDu < 0) then
        raise_application_error(-20001, 'So du phai lon hon hoac bang 0');
    end if;
end;
/
--ThuCung_trigger
...
begin
    if (:new.GiaVe < 0) then
        raise_application_error(-20002, 'Gia ve phai lon hon hoac bang 0');
    end if;
end;
/
...
begin
    if (:new.SoLuongVe <= 0) then
        raise_application_error(-20004, 'So luong ve phai lon hon 0');
    end if;
end;
/
...
begin
    if (:new.SoLuongMua <= 0) then
        raise_application_error(-20004, 'So luong ve mua phai lon hon 0');
    end if;
end;
/
...
begin
    if (:new.TongGiaTien < 0) then
        raise_application_error(-20004, 'Tong gia tien cua hoa don phai lon hon hoac bang 0');
    end if;
end;
/
----Procedure
