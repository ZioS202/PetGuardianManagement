...
public class Menu extends javax.swing.JPanel {
    ...
    // Method perform click MenuItem at specified index in ListMenu
    public void clickSpecificMenuItem(int index) {
        try {
            // Get current cursor's location on screen
            PointerInfo pointerInfo = MouseInfo.getPointerInfo();
            Point originLocation = new Point();
            if (pointerInfo != null) {
                originLocation = pointerInfo.getLocation();
            }

            // Get location of MenuItem
            Point newLocation = listMenu1.getMenuItemLocation(index);

            // TODO: prevent the user from moving the mouse physically
            Robot robot = new Robot();
            robot.mouseMove((int) newLocation.getX(), (int) newLocation.getY());
            robot.mousePress(InputEvent.BUTTON1_DOWN_MASK);
            robot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
            robot.mouseMove((int) originLocation.getX(), (int) originLocation.getY());
